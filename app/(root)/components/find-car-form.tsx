...
export default function FindCarForm({ data }: Props) {
  ...
  return (
    <div className="mt-2 motion-opacity-in-0 motion-duration-1000 motion-delay-500 flex w-full flex-col gap-y-2">
      ...
      <Link
        ...
        href={
          isNextButtonDisabled ? "#" : `/result/${selectedMake}/${selectedYear}`
        }
